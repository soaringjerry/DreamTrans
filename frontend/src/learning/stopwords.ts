/** Closed-class and ultra-high-frequency tokens that never receive learning glosses. */
export const LEARNING_STOPWORDS = new Set([
  ...
  'how\'s', 'as', 'because', 'until', 'although', 'though', 'whether', 'either',
  'neither', 'both', 'also', 'than', 'via', 'per', 'vs', 'etc', 'mr', 'mrs', 'ms',
  'dr', 'ok', 'okay', 'yeah', 'yes', 'no', 'oh', 'uh', 'um', 'ah', 'er', 'hmm',
