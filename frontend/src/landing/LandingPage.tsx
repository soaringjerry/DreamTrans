      ...
      <main>
        <section className="lp-hero" aria-labelledby="lp-hero-title">
          <div className="lp-hero__copy">
            <p className="lp-eyebrow">主业产品 · 实时语音工作台</p>
            <h1 id="lp-hero-title">
              把每一场对话，
              <br />
              变成清晰可用的文字。
          ...
          <div className="lp-hero__panel" aria-hidden="true">
            <div className="lp-mock">
              <div className="lp-mock__bar">
                ...
                <span>直播中 · 双语</span>
                <span className="lp-mock__timer">12:48</span>
              </div>
              <div className="lp-mock__row">
                <span className="lp-mock__speaker">Speaker A</span>
                <p className="lp-mock__en">
                  We should finalize the rollout checklist before Friday.
                </p>
                <p className="lp-mock__zh">我们最好在周五前敲定上线检查清单。</p>
              </div>
              <div className="lp-mock__row">
                <span className="lp-mock__speaker">Speaker B</span>
                <p className="lp-mock__en">
                  Agreed. Can you also summarize the open risks?
                </p>
                <p className="lp-mock__zh">没问题。你也可以把未决风险再总结一下吗？</p>
              </div>
        ...
        <section className="lp-strip" aria-label="产品要点">
          <div><strong>实时</strong><span>说话人分离转录</span></div>
          <div><strong>双语</strong><span>上下文 AI 翻译</span></div>
          <div><strong>AI</strong><span>问答 · 摘要 · 行动项</span></div>
          <div><strong>长会话</strong><span>可续录 · 可导出</span></div>
        </section>
        ...
        <section className="lp-section lp-section--muted" id="scenarios" aria-labelledby="lp-scenarios-title">
          ...
          <div className="lp-scenario-grid">
            {scenarios.map((item) => (
              <article className="lp-scenario" key={item.label}>
